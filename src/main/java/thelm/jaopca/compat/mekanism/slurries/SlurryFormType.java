	...
	public static void registerEntries() {
		...
		for(IForm form : FORMS) {
			...
			for(IMaterial material : form.getMaterials()) {
				...
				MekanismDataInjector.registerSlurryTag(helper.createResourceLocation(secondaryName), slurrySupplier);
				MekanismDataInjector.registerSlurryTag(helper.getTagLocation(secondaryName, material.getName()), slurrySupplier);
				for(String alternativeName : material.getAlternativeNames()) {
					MekanismDataInjector.registerSlurryTag(helper.getTagLocation(secondaryName, alternativeName), slurrySupplier);
				}
			}
		}
	}
